...
public class testController {
	...
	@ResponseBody
	public List<PropertyModel> details(@PathVariable("id") int id) {
		Material mater=new Material();	
		List<Object> list=Serivce.findList(mater, 1, 4);
		...
		return modelList;
		/*return (Orders) Serivce.findOneById(id,new Orders());*/
	}
	/*@RequestMapping("/find")
	@ResponseBody
	...
	*/
	...
	public List<Object> test(pageDomain pageDomain) {
		...
		Material mater=new Material();	
		return Serivce.findList(mater, 1, 4);
